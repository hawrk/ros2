...
static const _IMUInfo_type_support_symbol_names_t _IMUInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dros_common_interfaces, msg, IMUInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dros_common_interfaces, msg, IMUInfo)),
  }
};
...
{
  return &::dros_common_interfaces::msg::rosidl_typesupport_cpp::IMUInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dros_common_interfaces, msg, IMUInfo)() {
  return get_message_type_support_handle<dros_common_interfaces::msg::IMUInfo>();
}
