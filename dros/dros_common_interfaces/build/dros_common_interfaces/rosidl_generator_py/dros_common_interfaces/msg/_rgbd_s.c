...
bool dros_common_interfaces__msg__rgbd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dros_common_interfaces.msg._rgbd.RGBD", full_classname_dest, 37) == 0);
  }
  dros_common_interfaces__msg__RGBD * ros_message = _ros_message;
  {  // header
...
PyObject * dros_common_interfaces__msg__rgbd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dros_common_interfaces.msg._rgbd");
