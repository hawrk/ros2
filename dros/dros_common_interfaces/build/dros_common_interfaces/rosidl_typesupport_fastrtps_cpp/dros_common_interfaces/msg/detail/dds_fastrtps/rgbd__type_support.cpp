...
#include "dros_common_interfaces/msg/detail/rgbd__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dros_common_interfaces::msg::RGBD;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dros_common_interfaces::msg::RGBD *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dros_common_interfaces::msg::RGBD *>(
    untyped_ros_message);
...
{
  return &dros_common_interfaces::msg::typesupport_fastrtps_cpp::_RGBD__handle;
}
