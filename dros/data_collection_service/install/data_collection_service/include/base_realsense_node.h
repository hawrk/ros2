...
#include "dros_common_interfaces/msg/imu_info.hpp"
#include "dros_common_interfaces/msg/extrinsics.hpp"
#include "dros_common_interfaces/msg/metadata.hpp"
#include "dros_common_interfaces/msg/rgbd.hpp"
#include "dros_common_interfaces/srv/device_info.hpp"
...
using dros_common_interfaces::msg::Extrinsics;
using dros_common_interfaces::msg::IMUInfo;
using dros_common_interfaces::msg::RGBD;
...
namespace realsense2_camera
{
    ...
    protected:
        ...
        rclcpp::Service<dros_common_interfaces::srv::DeviceInfo>::SharedPtr _device_info_srv;
        ...
        void getDeviceInfo(const dros_common_interfaces::srv::DeviceInfo::Request::SharedPtr req,
    ...
    private:
        ...
        void SetBaseStream();
        void publishStaticTransforms();  // tf
        void startDynamicTf();   // tf
        void publishDynamicTransforms();  // tf 
        ...
        void setAvailableSensors();  // startup
        ...
        std::map<stream_index_pair, rclcpp::Publisher<dros_common_interfaces::msg::Metadata>::SharedPtr> _metadata_publishers;
        ...
        rclcpp::Publisher<dros_common_interfaces::msg::RGBD>::SharedPtr _rgbd_publisher;
