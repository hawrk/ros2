...
class Metaclass_DeviceInfo(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dros_common_interfaces.srv.DeviceInfo')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dros_common_interfaces.srv import _device_info
...
class DeviceInfo(metaclass=Metaclass_DeviceInfo):
    from dros_common_interfaces.srv._device_info import DeviceInfo_Request as Request
    from dros_common_interfaces.srv._device_info import DeviceInfo_Response as Response
