...
#include "dros_common_interfaces/srv/detail/device_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dros_common_interfaces::srv::DeviceInfo_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dros_common_interfaces::srv::DeviceInfo_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dros_common_interfaces::srv::DeviceInfo_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dros_common_interfaces::srv::DeviceInfo_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dros_common_interfaces::srv::DeviceInfo_Request *>(
    untyped_ros_message);
...
{
  return &dros_common_interfaces::srv::typesupport_fastrtps_cpp::_DeviceInfo_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dros_common_interfaces, srv, DeviceInfo_Request)() {
  return &dros_common_interfaces::srv::typesupport_fastrtps_cpp::_DeviceInfo_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dros_common_interfaces
cdr_serialize(
  const dros_common_interfaces::srv::DeviceInfo_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: device_name
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dros_common_interfaces::srv::DeviceInfo_Response & ros_message)
{
  // Member: device_name
  cdr >> ros_message.device_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dros_common_interfaces::srv::DeviceInfo_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dros_common_interfaces::srv::DeviceInfo_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dros_common_interfaces::srv::DeviceInfo_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &dros_common_interfaces::srv::typesupport_fastrtps_cpp::_DeviceInfo_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dros_common_interfaces, srv, DeviceInfo_Response)() {
  return &dros_common_interfaces::srv::typesupport_fastrtps_cpp::_DeviceInfo_Response__handle;
}
...
{
  return &dros_common_interfaces::srv::typesupport_fastrtps_cpp::_DeviceInfo__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dros_common_interfaces, srv, DeviceInfo)() {
  return &dros_common_interfaces::srv::typesupport_fastrtps_cpp::_DeviceInfo__handle;
}
