...
#include "dros_common_interfaces/msg/detail/imu_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dros_common_interfaces::msg::IMUInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dros_common_interfaces::msg::IMUInfo & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dros_common_interfaces::msg::IMUInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dros_common_interfaces::msg::IMUInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dros_common_interfaces::msg::IMUInfo *>(
    untyped_ros_message);
...
{
  return &dros_common_interfaces::msg::typesupport_fastrtps_cpp::_IMUInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dros_common_interfaces, msg, IMUInfo)() {
  return &dros_common_interfaces::msg::typesupport_fastrtps_cpp::_IMUInfo__handle;
}
