...
#ifndef DROS_COMMON_INTERFACES__MSG__DETAIL__IMU_INFO__STRUCT_HPP_
#define DROS_COMMON_INTERFACES__MSG__DETAIL__IMU_INFO__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__dros_common_interfaces__msg__IMUInfo __attribute__((deprecated))
#else
# define DEPRECATED__dros_common_interfaces__msg__IMUInfo __declspec(deprecated)
#endif
...
struct IMUInfo_
{
  ...
  // pointer types
  using RawPtr =
    dros_common_interfaces::msg::IMUInfo_<ContainerAllocator> *;
  using ConstRawPtr =
    const dros_common_interfaces::msg::IMUInfo_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<dros_common_interfaces::msg::IMUInfo_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<dros_common_interfaces::msg::IMUInfo_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      dros_common_interfaces::msg::IMUInfo_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<dros_common_interfaces::msg::IMUInfo_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<dros_common_interfaces::msg::IMUInfo_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<dros_common_interfaces::msg::IMUInfo_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<dros_common_interfaces::msg::IMUInfo_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__dros_common_interfaces__msg__IMUInfo
    std::shared_ptr<dros_common_interfaces::msg::IMUInfo_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__dros_common_interfaces__msg__IMUInfo
    std::shared_ptr<dros_common_interfaces::msg::IMUInfo_<ContainerAllocator> const>
...
using IMUInfo =
  dros_common_interfaces::msg::IMUInfo_<std::allocator<void>>;
...
#endif  // DROS_COMMON_INTERFACES__MSG__DETAIL__IMU_INFO__STRUCT_HPP_
