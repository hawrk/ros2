...
#ifndef DROS_COMMON_INTERFACES__MSG__DETAIL__RGBD__STRUCT_HPP_
#define DROS_COMMON_INTERFACES__MSG__DETAIL__RGBD__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__dros_common_interfaces__msg__RGBD __attribute__((deprecated))
#else
# define DEPRECATED__dros_common_interfaces__msg__RGBD __declspec(deprecated)
#endif
...
struct RGBD_
{
  ...
  // pointer types
  using RawPtr =
    dros_common_interfaces::msg::RGBD_<ContainerAllocator> *;
  using ConstRawPtr =
    const dros_common_interfaces::msg::RGBD_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<dros_common_interfaces::msg::RGBD_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<dros_common_interfaces::msg::RGBD_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      dros_common_interfaces::msg::RGBD_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<dros_common_interfaces::msg::RGBD_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<dros_common_interfaces::msg::RGBD_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<dros_common_interfaces::msg::RGBD_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<dros_common_interfaces::msg::RGBD_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__dros_common_interfaces__msg__RGBD
    std::shared_ptr<dros_common_interfaces::msg::RGBD_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__dros_common_interfaces__msg__RGBD
    std::shared_ptr<dros_common_interfaces::msg::RGBD_<ContainerAllocator> const>
...
using RGBD =
  dros_common_interfaces::msg::RGBD_<std::allocator<void>>;
...
#endif  // DROS_COMMON_INTERFACES__MSG__DETAIL__RGBD__STRUCT_HPP_
