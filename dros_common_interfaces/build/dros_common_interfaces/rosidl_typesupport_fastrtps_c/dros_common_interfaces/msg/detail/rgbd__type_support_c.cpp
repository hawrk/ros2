...
#include "dros_common_interfaces/msg/detail/rgbd__rosidl_typesupport_fastrtps_c.h"
...
using _RGBD__ros_msg_type = dros_common_interfaces__msg__RGBD;
...
size_t get_serialized_size_dros_common_interfaces__msg__RGBD(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RGBD__ros_msg_type * ros_message = static_cast<const _RGBD__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RGBD__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dros_common_interfaces__msg__RGBD(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dros_common_interfaces
size_t max_serialized_size_dros_common_interfaces__msg__RGBD(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dros_common_interfaces__msg__RGBD;
    is_plain =
      (
...
static size_t _RGBD__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dros_common_interfaces__msg__RGBD(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dros_common_interfaces, msg, RGBD)() {
